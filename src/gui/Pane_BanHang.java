...
//		setLayout(new BorderLayout());
		...
		cbo_donVi.setPreferredSize(new Dimension(300, 25));
		...
		jp_loc.add(Box.createVerticalStrut(30));
		...
		model_sanPham = new DefaultTableModel(colnames_sanPham, 0) {
			// Dùng hàm isCellEditable để chỉ định các trường được chỉnh sửa trong trường hợp này là không cho phép
		...
		// Tạo một Arraylist chứa các sản phẩm được trả về từ hàm getalltbSanPham
		...
		// Tạo model hóa đơn cho bảng hóa đơn và set chỉ được chỉnh sửa cột thứ 4(số lượng)
